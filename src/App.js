  ...
  function moveSnake() {
    ...
    if (bait[0] === headOfSnake[0] && bait[1] === headOfSnake[1]) {
      ...
      if (speed === 1)
        setHighScore({
          ...highScore,
          easy: Math.max(highScore["easy"], score + 1),
        });
      else if (speed === 2)
        setHighScore({
          ...highScore,
          medium: Math.max(highScore["medium"], score + 1),
        });
      else if (speed === 3)
        setHighScore({
          ...highScore,
          hard: Math.max(highScore["hard"], score + 1),
        });
      else
        setHighScore({
          ...highScore,
          PESTO: Math.max(highScore["PESTO"], score + 1),
        });
    }
